    ...
    return (
        <div className="shadow-lg rounded-lg p-8 w-full max-w-4xl">
            ...
            <div className="flex gap-4 mb-6 justify-start">
                <Link href="https://drive.google.com/file/d/1URAETBXrFJc9DHoEuMCJVeaLHgCX_H03/view?usp=sharing" target="_blank" className="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition">
                    Bases
                </Link>
            </div>
